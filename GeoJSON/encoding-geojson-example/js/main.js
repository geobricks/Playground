...
function init() {
    ...
    var service = "http://localhost:5925/spatialquery/db/spatial/query/";
    var url = service + "SELECT ST_AsGeoJSON(geom), adm0_code, adm0_name FROM spatial.gaul0_2015_4326 WHERE adm0_code IN (1)?geojsonEncoding=True";
